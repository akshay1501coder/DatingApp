    ...
    public class MessageHub : Hub
    {
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            else
            {
                ...
                if (connections != null)
                {
                    //to get online users but not with same group
        ...
        /*
        we are passing caller:person who is sending msg , 
        other:to whom msg is written to
        This function will return string in alphabetical order which will
        be used to create hub group
        */
